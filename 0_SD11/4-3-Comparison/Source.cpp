...
int main()
{
	double bodyFatOne = calculate_body_fat();
	double bodyFatTwo = calculate_body_fat();
	cout << "The " << (bodyFatOne < bodyFatTwo ? "first" : "second") << " entry has the lowest fat percentage at " << min(bodyFatOne, bodyFatTwo) <<"\n";
}