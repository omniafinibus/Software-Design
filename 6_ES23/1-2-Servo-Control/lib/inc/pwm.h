...
/**
 * run a function on every change of state
 * 
 * @param state - char
 *        required state of PWM
 *        high = 1, low = 0
 */
 ...
 * Set width of PWM signal in us.
 * 
 * @param highFunction - void
 *        address of function to run on a rise state
 * 
 * @param lowFunction - void
 *        address of function to run on a fall state
 */
