...
volatile char * stopWatchStatus3;
volatile char * stopWatchStatus4;
volatile int stopWatchDelay3 = 0;
...
void startStopWatch3(volatile char * status, int delayInSec)
{
    ...
    timer_reset(3);
    //connect interrupt
    timer_attachInterrupt(3, 6, 2);
    //attach flag address
    stopWatchStatus3 = status;
    //setup counter
    stopWatchDelay3 = delayInSec;
    counter3 = 0;    
}
...
{
    if(counter3 == stopWatchDelay3)
    {
        *stopWatchStatus3 = 1;        
    }
    else if(counter3 < stopWatchDelay3)
    {
        counter3++;
        *stopWatchStatus3 = 0;
    }
    IFS0bits.T3IF = 0;      //turn timer 2 interrupt flag off
}
